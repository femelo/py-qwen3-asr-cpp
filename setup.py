# This setup.py is used to build the py_qwen3_asr_cpp package.
# The environment variables you may find interesting are:
#
# PY_QWEN3_ASR_CPP_VERSION
...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        dll_folder = os.path.join(self.build_temp, "_py_qwen3_asr_cpp", "bin", cfg)
...
class RepairWheel(bdist_wheel):
    ...
    def repair_wheel(self):
        ...
        with tempfile.TemporaryDirectory(prefix="repaired_wheel_") as tmp_dir:
            ...
            # on linux from py-qwen3-asr-cpp-1.2.0-cp312-cp312-linux_aarch64.whl
            #            to py-qwen3-asr-cpp-1.2.0-cp312-cp312-manylinux_2_34_aarch64.whl
...
def get_version() -> str:
    try:
        return os.environ["PY_QWEN3_ASR_CPP_VERSION"]
    except KeyError:
        pass
...
setup(
    name="py-qwen3-asr-cpp",
    author="femelo",
    description="Python bindings for qwen3-asr.cpp",
    long_description=long_description,
    ext_modules=[CMakeExtension("py_qwen3_asr_cpp._py_qwen3_asr_cpp", sourcedir=".")],
    cmdclass={
    ...
    entry_points={
        "console_scripts": [
            "pqw3=py_qwen3_asr_cpp.examples.main:main",
            "pqw3-assistant=py_qwen3_asr_cpp.examples.assistant:_main",
            "pqw3-livestream=py_qwen3_asr_cpp.examples.livestream:_main",
            "pqw3-recording=py_qwen3_asr_cpp.examples.recording:_main",
        ]
    },
    project_urls={
        "Source": "https://github.com/femelo/py-qwen3-asr-cpp",
        "Tracker": "https://github.com/femelo/py-qwen3-asr-cpp/issues",
    },
